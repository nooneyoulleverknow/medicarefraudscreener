...
I must say I been banned on x for over a week over a false positive, I was planning to announce this over x.  But X's customer service experience is the freshest piles of cow excrement anywhere in the world.  They should stop employing cow piss guzzlers, and usage of AI should be heuristic for which ML based AI is supposed to converge anyways-except for LLM based AI which is just a disaster waiting to happen.
